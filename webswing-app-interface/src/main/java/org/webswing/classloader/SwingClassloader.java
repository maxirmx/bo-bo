...
public class SwingClassloader extends URLClassLoader {
	...
	public SwingClassloader(URL[] classpath, ClassLoader parent) {
		...
		this.ignored_packages = new String[] { "java.", "javax.",  "com.sun.","sun.","javafx.", "org.xml.sax.", "org.omg.CORBA.", "org.w3c.dom.", "org.webswing.special", "org.webswing.model", "org.webswing.toolkit", "netscape.javascript" };

...
public class ConfigurationImpl extends Configuration {
	...
	private void readPropertyFile(String filename) throws IOException {
		...
		setTruststorePassword(String.valueOf(BaseUtils.decrypt(prop.getProperty("org.webswing.server.https.truststore.password").toCharArray())));
		setKeystore(prop.getProperty("org.webswing.server.https.keystore"));
		setKeystorePassword(String.valueOf(BaseUtils.decrypt(prop.getProperty("org.webswing.server.https.keystore.password").toCharArray())));
